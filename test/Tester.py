...
if __name__ == '__main__':
    ...
    family.addPerson(1, "Braiden Cobb", 1924, GENDER.FEMALE)
    family.addPerson(2, "Aiyana Cobb", 1924, GENDER.MALE)
    ...
    family.addPerson(3, "Israel Cobb", 1954, GENDER.FEMALE)
    family.addPerson(4, "Ariel Cobb", 1975, GENDER.FEMALE)
    ...
    family.setCouple(3, 5)
    family.addPerson(6, "Ivy Cobb", 2010, GENDER.FEMALE)
    family.setMother(3, 6)
    family.setFather(5, 6)
